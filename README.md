...
Fixed post-proccesing for OrcaSlicer for generating compatible thumbnails for Creality Ender 3 S1 Pro

Origin script have set up image size 200x200 but this size is not working for Ender 3 S1 Pro, so i fix it to 300x300 and now its working properly for S1 Pro.
